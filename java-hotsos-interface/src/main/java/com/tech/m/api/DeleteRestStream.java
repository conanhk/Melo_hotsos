...
@XmlRootElement(name = "DeleteRestStream")
public class DeleteRestStream {

    @XmlElementRef(name = "type", namespace = "urn:api.m-tech.com", type = JAXBElement.class, required = false)
    protected JAXBElement<String> type;
    @XmlElementRef(name = "operation", namespace = "urn:api.m-tech.com", type = JAXBElement.class, required = false)
