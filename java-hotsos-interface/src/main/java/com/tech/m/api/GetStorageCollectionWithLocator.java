...
@XmlRootElement(name = "GetStorageCollectionWithLocator")
public class GetStorageCollectionWithLocator {

    @XmlElementRef(name = "type", namespace = "urn:api.m-tech.com", type = JAXBElement.class, required = false)
    protected JAXBElement<String> type;
    @XmlElementRef(name = "locator", namespace = "urn:api.m-tech.com", type = JAXBElement.class, required = false)
